...
Click the following link to register: [BbqCryptoBot](https://t.me/BBQcoin_bot/BBQcoin?startapp=rp_9000016_1719410244)
...
2. Clone this repository.
   ```shell
   git clone https://github.com/ShadowScripts1/TG-bbq
   ```

3. Enter the TG-bbq folder
   ```
   cd TG-bbq
   ```

4. Edit the `data.txt` file, enter your query data into the `data.txt` file. One line for 1 account, if you want to add a 2nd account, fill it in on a new line.

5. Run the program/script.
   ```
   python bot.py
   ```
